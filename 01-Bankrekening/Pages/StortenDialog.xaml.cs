...
{
    public sealed partial class StortenDialog : ContentDialog
    {
        public decimal result { get; set; } = 0.0m;

        public StortenDialog()
        {
        ...
        private void ContentDialog_StortenButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
        {
